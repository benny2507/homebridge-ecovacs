...
export default class {
  ...
  initialiseDevice(device) {
    try {
      ...
      // Models defined here will be forced to use V2 commands
      const v2DeviceClasses = [
        '3sp2in', // X5 Pro
        'eco-ng', // Newer Ecovacs platforms
      ]
      
      const forceV2 = v2DeviceClasses.includes(loadedDevice.vacuum.class)
      
      accessory.context.commandSuffix = (accessory.control.is950type_V2() || forceV2)
        ? '_V2'
        : ''
